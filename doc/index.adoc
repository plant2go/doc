...
image::https://plant2go.github.io/design/presentation-template/Plant2Go_PresentationTemplate.pdf[pages=1..10]

=== Service Flip

image::CircularDesign_Service Flip_plant2go.pdf[pages=1]

=== Assumption Matrix

image::AssumptionMatrix_plant2go.pdf[pages=1]

=== W-Fragen

image::W-Fragen_plant2go.pdf[pages=1]